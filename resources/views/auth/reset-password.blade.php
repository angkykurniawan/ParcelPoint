    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-form">
                ...
                <h3 class="text-primary text-center" style="font-weight: bolder;">Ganti Password</h3>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    @csrf
                    <input type="hidden" name="token" value="{{ $token ?? ($request ? $request->route('token') : '') }}">

                    <div class="mb-3 text-start">
                        <label for="email" class="form-label text-primary Tri fw-bold small">Email</label>
                        <input id="email" type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $email ?? ($request ? $request->email : '')) }}" required autofocus autocomplete="username">
                        @error('email')
                    ...
                    <div class="mb-3 text-start">
                        <label for="password" class="form-label text-primary fw-bold small">Password Baru</label>
                    ...
                    <div class="mb-4 text-start">
                        <label for="password_confirmation" class="form-label text-primary fw-bold small">Konfirmasi Password Baru</label>
                    ...
                    <button type="submit" class="btn btn-primary w-100 shadow-sm">Ganti</button>
                </form>
            </div>
        </div>
    </div>
