    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-form">
                ...
                <h3 class="text-primary text-center" style="font-weight: bolder;">Lupa Password</h3>
                <p class="text-muted text-center small mb-4">Masukkan email terdaftar untuk menerima link pemulihan password akun Anda.</p>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="mb-4 text-start">
                        <label for="email" class="form-label text-primary fw-bold small">Email Akun</label>
                    ...
                    <button type="submit" class="btn btn-primary w-100 shadow-sm">Kirim Link Ganti Password</button>
                </form>
