    ...
    <div class="col-12">
        <div class="card" style="border-radius: 16px; border: 1px solid #e1eeff; box-shadow: 0 10px 30px rgba(13, 110, 253, 0.03);">
            <div class="card-body p-4">
                ...
                <!-- Header, Search Form, and Action Button -->
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 mb-4">
                    <h3 class="text-primary m-0" style="font-weight: 800;"><i class="ti ti-crown me-2"></i>Data Pemilik Surat & Paket</h3>

                    <div class="d-flex flex-column flex-sm-row gap-2 w-100 w-md-auto align-items-center">
                        <form action="/pemilik" method="GET" class="d-flex w-100 w-sm-auto">
                            <input type="text" name="search" value="{{ request()->get('search') }}" class="form-control me-2" placeholder="Cari nama pemilik..." style="border: 2px solid #cbdfff; border-radius: 12px; padding: 8px 16px;">
                        ...
                        <a href="/pemilik/create" class="btn btn-primary w-100 w-sm-auto shadow-sm text-nowrap" style="border-radius: 12px; background-color: #3475FE; border: none; padding: 10px 16px; font-weight: 600;">
