...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <center><div class="card-header text-primary" style="font-weight: bolder;">DATA {{ strtoupper($suratPaket->Jenis) }} DENGAN NOMOR RESI <strong>{{ strtoupper($suratPaket->Resi) }}</strong></div></center>
                <div class="card-body">
                    <h4 class="text-primary" style="font-weight: bolder;">Data Pemilik</h4>
                    <table width="100%">
                        <tbody>
                            <tr>
                                <th class="text-primary"  width="15%">Nomor Induk</th>
                            ...
                            <tr>
                                <th class="text-primary" >Pekerjaan</th>
                    ...
                    <hr>
                    <h4 class="text-primary" style="font-weight: bolder;">Data {{ $suratPaket->Jenis }} Terbaru</h4>
                    <table width="100%">
                        <tbody>
                            <tr>
                                <th class="text-primary"  width="15%">Resi</th>
                            ...
                            <tr>
                                <th  class="text-primary" >Berat</th>
                                <td> : {{ $suratPaket->Berat }} Gram</td>
                            </tr>
                            <tr>
                                <th  class="text-primary">Status Surat Paket</th>
                                <td> :
                    ...
                    <hr>
                    <h4  class="text-primary" style="font-weight: bolder;">Serah Terima {{ $suratPaket->Jenis }}</h4>
                    <form action="/suratPaket/{{ $suratPaket->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-1 mb-3">
                            <label for="Penjemput" class="text-primary" style="font-weight: bolder;">Penjemput</label>
                        ...
                        <div class="form-group mt-1 mb-3">
                            <label for="WaktuJemput" class="text-primary" style="font-weight: bolder;">Waktu Jemput</label>
